   ...
   <tbody>
    <?php
      while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo '</td>';
        echo '<td>'; 
        echo '<a href="../php/Editajurados.php?id=' . '"><img src="../assets/img/editar.png" alt="Editar"></a>';
        echo '<a href="../php/Excluirjurados.php?id=' . '"><img src="../assets/img/deletar.png" alt="Deletar"></a>';
        echo '</td>';
        echo '</tr>';
      }
      ?>
